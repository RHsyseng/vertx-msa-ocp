package com.redhat.refarch.vertx.lambdaair.sales.model;
...
public class Itinerary {
    ...
    public static Comparator<Itinerary> durationComparator = Comparator.comparing(Itinerary::getDuration);
}